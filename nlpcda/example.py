...
def main():
    data_name = ['campus_card', 'curricula_variable', 'employment_guidance', 'library', 'psychological_consulting',
                 'railway_ticket']
    res = []
    for name in tqdm(data_name):
        res.append(name)
        with open(f"/home/wangzhili/YangYang/rasa_ch_faq/data/nlu/{name}.yml") as f:
